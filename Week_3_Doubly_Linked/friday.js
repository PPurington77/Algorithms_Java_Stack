...
console.log(firstThreeList.insertAfter(4,5));
console.log(firstThreeList.insertAfter(2,5));
console.log(firstThreeList.insertAfter(3,5));

console.log(firstThreeList.toArray());

// console.log(firstThreeList.insertBefore(2, 5));
// console.log(firstThreeList.toArray());
